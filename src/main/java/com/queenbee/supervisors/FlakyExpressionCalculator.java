...
import static com.queenbee.supervisors.Expression.*;
import static com.queenbee.supervisors.FlakyExpressionCalculator.Position.*;
...
public class FlakyExpressionCalculator extends AbstractLoggingActor {
  ...
  public void preStart() {
    log().info(this.getClass().getSimpleName() + " : preStart");
